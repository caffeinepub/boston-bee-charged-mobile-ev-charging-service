...
import { Zap, Clock, MapPin, Shield, Battery, Smartphone } from 'lucide-react';
  ...
  const features = [
    {
      icon: Zap,
      title: 'Fast Charging',
      description: 'Quick and efficient mobile charging service for all EV models',
    },
    {
      icon: Clock,
    ...
    },
    {
      icon: Shield,
      title: 'Safe & Reliable',
      description: 'Professional service with certified equipment and trained technicians',
    },
    {
      icon: Battery,
      title: 'All EV Models',
            ...
            <div className="flex flex-col justify-center space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-lg text-muted-foreground md:text-xl">
                  Boston's premier mobile electric vehicle charging service. We bring the power to your location, so you can stay charged and ready to go.
                </p>
              </div>
              <div className="flex flex-col gap-3 sm:flex-row">
                <Button size="lg" onClick={() => navigate({ to: '/schedule' })} className="text-base">
                  Schedule Charging
                </Button>
        ...
        <div className="container">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
              We make EV charging convenient, reliable, and hassle-free with our mobile charging service.
            </p>
          </div>
            ...
            {[
              {
                step: '1',
                title: 'Book Online',
                description: 'Schedule your charging appointment through our easy-to-use booking system',
              },
              {
                step: '2',
                title: 'We Come to You',
                description: 'Our mobile charging unit arrives at your specified location at the scheduled time',
              },
              {
                step: '3',
                title: 'Get Charged',
          ...
          <Card className="border-2 border-primary/20 bg-gradient-to-br from-primary/5 to-accent/5">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-lg">
                Book your mobile EV charging appointment today and experience the convenience of on-demand charging.
              </CardDescription>
            </CardHeader>

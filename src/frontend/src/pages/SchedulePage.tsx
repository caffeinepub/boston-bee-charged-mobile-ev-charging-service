...
import type { BatteryCapacity, VehicleType } from "../backend";
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Fill in the information below to schedule your charging session
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setBatteryCapacity(value as BatteryCapacity)
                  }
                >
